...
function testAvailableMembers( ){
    ...
    zz.environment.TestRunner.checkMembers( members, env );
    zz.environment.TestRunner.checkMembers( deviceMembers, env.device, 'device:' );
    zz.environment.TestRunner.checkMembers( osMembers, env.os, 'os:' );
    zz.environment.TestRunner.checkMembers( browserEngineMembers, env.browserEngine, 'browserEngine:' );
    zz.environment.TestRunner.checkMembers( browserMembers, env.browser, 'browser:' );
    zz.environment.TestRunner.checkMembers( viewportMembers, env.viewport, 'viewport:' );
}
...
function testBrowserEngine( ){
    ...
    assertTrue(
        ...
        'Property must have a type of Object',
        goog.isObject( env.browserEngine )
    );
}
