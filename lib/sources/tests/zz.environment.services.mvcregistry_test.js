...
function setUp( ){
    ...
    testSubj = new zz.environment.services.MVCRegistry( );
    model = 'model';
...
function testAvailableMembers( ){
    ...
    zz.environment.TestRunner.checkMembers( members, testSubj );
    zz.environment.TestRunner.checkMembers( staticMembers, zz.environment.services.MVCRegistry, 'Static:' );
}
...
function testConstructor( ){
    ...
    assertTrue(
        ...
        testSubj instanceof zz.environment.services.MVCRegistry
    );
}
