...
goog.provide( 'zz.environment.tests.Offline' );
goog.setTestOnly( 'zz.environment.tests.Offline' );
...
function testConstructor( ){
    ...
    assertTrue(
        ...
        event instanceof zz.environment.events.Offline
    );
}
