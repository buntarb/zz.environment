...
zz.environment.services.MVCTree.prototype.generateUid_ = function( uid, attr, opt_val ){
    ...
    // if( attr === zz.environment.enums.ViewElementAttribute.CONTROLLER ){
    //
    //     var field;
    //     if( field = this.getViewElementAttribute_( element, zz.environment.enums.ViewElementAttribute.MODEL ) ){
    //
    //         return uid +
    //
    //             this.uidInternalSeparator_ +
