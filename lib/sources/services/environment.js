...
/**
 * Reset root controller. Dispose existing root controller.
 */
zz.environment.services.Environment.prototype.resetRootController = function( ){

	if( this.rootController_ ){

		if( !this.rootController_.isDisposed( ) ){

			this.rootController_.dispose( );
		}
		this.rootController_ = false;
	}
};
